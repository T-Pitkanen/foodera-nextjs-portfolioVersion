        ...
        <div className={styles.container}>
            ...
            {affiliates.map((affiliate, index) => {
                    ...
                    return (
                        <span className={styles.affiliateContainer} key={index}>
                            <Image className={styles.affiliateImg} src={affiliate.imagePath} alt={affiliate.title} width={100} height={100}/>
                            <button onClick={(e) => handleDelete(e, affiliate._id)}>Delete</button>
                        </span>
                    )
            })}
            ...
            <form onSubmit={handleSubmit}>
                <label> Affiliate title
                    <input type="title" name="title" placeholder="Affiliate Title" defaultValue={'New Partner in Food'}/>
                </label>
                <label> Choose File
