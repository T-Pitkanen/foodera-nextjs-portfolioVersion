        ...
        <div className={styles.pagination}>
            ...
            <div className={styles.paginationBar}>
                {list.map((item, index) => {
                    ...
                    return <div key={index} className={`${styles.paginationDot} ${currentIndex === index ? styles.active : ''}`} onClick={ () => slideTo(index)}></div>
    ...
    return (
        <div className={styles.container}>
            <div className={`wrapper`}>
                    ...
                    {reviewsList.map((review, index) => {   
                        ...
                        return (
                            <swiper-slide key={index}>
                                <Testimonial imagePath={review.imagePath} name={review.name} text={review.text}></Testimonial>
                            </swiper-slide>
                        )
                ...
                <footer>
                    <PaginationBar list={reviewsList} slideTo={slideTo} currentIndex={currentIndex}></PaginationBar>
                </footer>
